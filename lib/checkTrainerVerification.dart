...
class CheckTrainerVerification extends StatefulWidget {
  CheckTrainerVerification({Key? key}) : super(key: key);

  @override
  State<CheckTrainerVerification> createState() =>
      _CheckTrainerVerificationState();
}

class _CheckTrainerVerificationState extends State<CheckTrainerVerification> {
