...
class CheckUserDeactivation extends StatefulWidget {
  CheckUserDeactivation({Key? key}) : super(key: key);

  @override
  State<CheckUserDeactivation> createState() => _CheckUserDeactivationState();
}

class _CheckUserDeactivationState extends State<CheckUserDeactivation> {
