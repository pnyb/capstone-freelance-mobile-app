...
class addTrainerInclusions extends StatefulWidget {
  final String id;
  ...
  final File serviceBgPhoto;
  final List<File> imagesUrl;

  const addTrainerInclusions({
    Key? key,
    required this.id,
  ...
  @override
  _addTrainerInclusionsState createState() => _addTrainerInclusionsState();
}

class _addTrainerInclusionsState extends State<addTrainerInclusions> {
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  buildTextField('Additional Price', dietPlanAmount),
                  SizedBox(height: 20),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: Row(
                  ...
                  SizedBox(height: 5),
                  buildTextField('Additional Price', progressTrackAmount),
                  SizedBox(height: 60),
                  Center(
                    child: Container(
                      width: 350,
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          bool shouldSave = await _showConfirmDialog(context);

                          if (shouldSave) {
                            for (int i = 0; i < widget.imagesUrl.length; i++) {
                              String galleryId = uuid.v4();
                            ...
                            final ref = FirebaseStorage.instance
                                ...
                                .child('${widget.id}.jpg');
                            await ref.putFile(widget.serviceBgPhoto);
