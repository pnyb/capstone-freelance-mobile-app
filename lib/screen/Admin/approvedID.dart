...
class approvedID extends StatefulWidget {
  @override
  _approvedIDState createState() => _approvedIDState();
}

class _approvedIDState extends State<approvedID> {
    ...
    return FirebaseFirestore.instance
        ...
        .map((snapshot) => snapshot.docs
            .where((QueryDocumentSnapshot<Object?> element) =>
                element['isIDApproved'].toString().contains("true"))
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image.asset(
                                     'assets/images/verifiedlogo.png',
                                    height: 60,
                                    width: 60,
                                  ),
                                ),
