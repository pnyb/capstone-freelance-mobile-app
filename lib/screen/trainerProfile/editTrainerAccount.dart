...
class EditTrainerAccount extends StatefulWidget {
  @override
  _EditTrainerAccountState createState() => _EditTrainerAccountState();
}

class _EditTrainerAccountState extends State<EditTrainerAccount> {
                            ...
                            onPressed: () async {
                              ...
                              if (firstNameController.text.isEmpty ||
                                ...
                                if (editImage == true) {
                                  ...
                                  final trainerData = FirebaseFirestore.instance
                                      .collection('Trainer Profile')
                                      .doc("trainer-${_profiles.first.id}");

                                  final tData = {
                                    "name":
                                        "${_profiles.first.firstName} ${_profiles.first.lastName}",
                                  };
                                  trainerData.update(tData);
