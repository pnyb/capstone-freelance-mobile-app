...
import 'package:flexedfitness/screen/trainerProfile/editTrainerProfile2.dart';
  ...
  void initState() {
    FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((doc) {
        ...
        setState(() {
          isloaded = true;
          locationController.text = _profiles.first.location;
          jobPositionController.text = _profiles.first.jobDescription;
          finalJob = _profiles.first.jobDescription;
          aboutMeController.text = _profiles.first.aboutMe;
        });
      });
