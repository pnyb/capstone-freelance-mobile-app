...
class addIdTrainer extends StatefulWidget {
  ...
  @override
  _addIdTrainerState createState() => _addIdTrainerState();
}

class _addIdTrainerState extends State<addIdTrainer> {
                      ...
                      onPressed: () async {
                        ...
                        if (editImage == true || typeOfId.text.isNotEmpty) {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => RegisterTrainer1(
