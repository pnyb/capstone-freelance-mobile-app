...
class RegisterTrainer1 extends StatefulWidget {
  ...
  @override
  _RegisterTrainer1State createState() => _RegisterTrainer1State();
}

class _RegisterTrainer1State extends State<RegisterTrainer1> {
