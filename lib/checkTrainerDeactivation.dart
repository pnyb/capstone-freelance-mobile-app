...
class CheckTrainerDeactivation extends StatefulWidget {
  CheckTrainerDeactivation({Key? key}) : super(key: key);

  @override
  State<CheckTrainerDeactivation> createState() =>
      _CheckTrainerDeactivationState();
}

class _CheckTrainerDeactivationState extends State<CheckTrainerDeactivation> {
